...
$$ X_{t+1} = \theta X_t + \epsilon_t ~~~~où ~~~~ X_0 = \frac{c}{1-\theta} ~~~ et~~~~ \epsilon_t~~ \longrightarrow ~~\mathcal{N}(c,\sigma^2)~~~~et~~~\theta \in [0,1[$$
Par recurrence on montre que: 
$$ X_t=\theta^tX_{0}+\sum_{k=0}^{t-1}\theta^k\varepsilon_{t-k} $$ 
